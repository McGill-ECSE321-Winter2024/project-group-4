...
public class TestScheduledClassService {
  ...
  @Mock private OfferedClassRepository offeredClassRepository;
  ...
  public void setMockOutput() {
    lenient()
        .when(offeredClassRepository.findOfferedClassByOfferedClassId(any(Integer.class)))
        .thenAnswer(
    ...
    lenient()
        .when(instructorRepository.findInstructorByroleId(any(Integer.class)))
        .thenAnswer(
            (InvocationOnMock invocation) -> {
    ...
    lenient()
        .when(scheduledClassRepository.findAll())
        .thenAnswer(
            (InvocationOnMock invocation) -> {
              ...
              ScheduledClass s1 =
                  new ScheduledClass(
                      startTime, endTime, localDate, new OfferedClass("FireBending", "Fireball"));
    ...
    try {
      scheduledClass =
          scheduledClassService.createScheduledClass(
              startTime, endTime, localDate, OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
    } catch (Exception e) {
      fail();
    }
  ...
  public void testFakeInstructorAndOfferedClassUnsuccesfulCreateScheduledClass() {
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              startTime, endTime, localDate, FAKE_OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
        });
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              startTime, endTime, localDate, OFFERED_CLASS_KEY, FAKE_INSTRUCTOR_KEY);
        });
  }
  ...
  public void testWrongTimeAndDateUnsuccesfulCreateScheduledClass() {
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              badStartTime, goodEndTime, goodDate, OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
        });
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              goodStartTime, badEndTime, goodDate, OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
        });
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              goodStartTime, goodEndTime, badDate, OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
        });
  }
  ...
  public void testExistingClassAtWantedTimeUnsuccesfulCreateScheduledClass() {
    ...
    assertThrows(
        ...
        () -> {
          scheduledClassService.createScheduledClass(
              startTime, endTime, aDate, OFFERED_CLASS_KEY, INSTRUCTOR_KEY);
        });
  }
  ...
  public void testDeleteScheduledClass() throws Exception {
    ...
    ScheduledClass scheduledClass =
        scheduledClassService.createScheduledClass(
            startTime, endTime, aDate, offeredclass.getId(), instructor.getRoleId());
    int id = scheduledClass.getScheduledClassId();
    ScheduledClass deletedScheduledClass =
        scheduledClassService.deleteScheduledClass(scheduledClass);
