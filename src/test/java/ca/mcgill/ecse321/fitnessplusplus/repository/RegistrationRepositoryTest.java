...
public class RegistrationRepositoryTest {
  ...
  /**
   * Test writing and reading attributes of Registration Edits an attribute value and checks if the
   * value has been updated in the repository
   *
   * @author Yonatan Bensimon
   */
  @Test
  public void testReadWriteRegistrationAttributes() {
    ...
    Registration retrievedRegistration =
        registrationRepositoryTest.findByClientAndScheduledClass(client, scheduledClass);
