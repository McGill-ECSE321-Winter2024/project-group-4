...
public class RegisteredUserRepositoryTest {
  ...
  public void testReadWriteRegisteredUser() {
    ...
    RegisteredUser retrievedUser =
        registeredUserRepository.findRegisteredUserByUsername("John_Doe");
  ...
  /**
   * Test writing and reading attributes of RegisteredUser Edits the attribute values and checks if
   * the values have been updated in the repository
   *
   * @author Neil Joe George
   */
  @Test
  public void testReadWriteRegisteredUserAttributes() {
    ...
    RegisteredUser retrievedUpdatedUser =
        registeredUserRepository.findRegisteredUserByUsername("John_Doe");
    // Assert attributes of the retrieved user match the original user
